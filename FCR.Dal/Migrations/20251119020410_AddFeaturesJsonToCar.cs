...
{
    /// <inheritdoc />
    public partial class AddFeaturesJsonToCar : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Transmission = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Automatic"),
                    ...
                    MonthlyRate = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    WeeklyRate = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_IsAvailable_IsDeleted",
                table: "Cars",
                columns: new[] { "IsAvailable", "IsDeleted" });
